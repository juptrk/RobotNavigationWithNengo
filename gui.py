...
class Gui():
    def __init__(self, master, nengo, limit):
        ...
        self.ax4.plot(nengo.sim.trange(), nengo.sim.data[nengo.distance_neuron_probe], label='Dist Neurons')
        ...
        self.ax4.legend(loc='upper center', bbox_to_anchor=(0.5, 1.05), ncol=3, fancybox=True, shadow=True)
